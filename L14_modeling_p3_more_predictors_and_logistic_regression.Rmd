---
title: "Modeling, part 3, multiple predictors again, logistic regression - student copy"
...
library(openintro) # may need to install
library(ggridges)
library(patchwork)
set.seed(1234)
...
Plot:
```{r plotly-plot, echo = T,warning=FALSE}
